import { FormSection } from "@/components/purchases/form-sections/FormSection";
...
export const TravelAttachmentSection = ({ travelRequestId, onFilesChange }: AttachmentSectionProps) => {
